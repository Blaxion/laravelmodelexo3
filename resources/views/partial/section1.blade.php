<section>
    <div class="container mt-5 mb-5 p-4 bg-secondary rounded">
        <div class="w-100 text-center display-3 mb-4 text-white bg-dark ">Tous les membres</div>
        ...
        @foreach ($membres as $membre )
            <div class="rounded {{$membre->genre === 'Homme'?'bg-primary':'bg-info'}} text-white row row-cols-4 m-2 text-left">
