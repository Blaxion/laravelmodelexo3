<section>
    <div class="container mt-5 mb-5 p-4 bg-secondary rounded">
        <div class="w-100 text-center display-3 mb-4 text-white bg-dark ">Les hommes en condition</div>
        ...
        <div class="rounded {{(($membre->age >= '18' and $membre->age <= '24')and $membre->genre === 'Homme')?'':'d-none'}}   bg-dark text-white row row-cols-4 m-2 text-left">
